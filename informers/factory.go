...
import (
	...
	admissionregistration "k8s.io/client-go/v8/informers/admissionregistration"
	apps "k8s.io/client-go/v8/informers/apps"
	autoscaling "k8s.io/client-go/v8/informers/autoscaling"
	batch "k8s.io/client-go/v8/informers/batch"
	certificates "k8s.io/client-go/v8/informers/certificates"
	coordination "k8s.io/client-go/v8/informers/coordination"
	core "k8s.io/client-go/v8/informers/core"
	events "k8s.io/client-go/v8/informers/events"
	extensions "k8s.io/client-go/v8/informers/extensions"
	internalinterfaces "k8s.io/client-go/v8/informers/internalinterfaces"
	networking "k8s.io/client-go/v8/informers/networking"
	policy "k8s.io/client-go/v8/informers/policy"
	rbac "k8s.io/client-go/v8/informers/rbac"
	scheduling "k8s.io/client-go/v8/informers/scheduling"
	settings "k8s.io/client-go/v8/informers/settings"
	storage "k8s.io/client-go/v8/informers/storage"
